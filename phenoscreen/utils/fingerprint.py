...
class Fingerprint():
    ...
    def __init__(self, fingerprint_type_list=["ECFP4"]):
        ...
        self.similarity_metrics = {
            ...
            "TverskyR": lambda ref, query: DataStructs.cDataStructs.TverskySimilarity(query, ref, 0.01, 0.99),
            "TverskyF": lambda ref, query: DataStructs.cDataStructs.TverskySimilarity(ref, query, 0.01, 0.99),
            "Tversky": lambda ref, query: DataStructs.cDataStructs.TverskySimilarity(ref, query, 0.5, 0.5),
        }
